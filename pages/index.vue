<template>
<div id="about-page2" class="page-wrapper about-page content-page">
<div class="section page-main-section">
<div class="container">
<div class="columns"><!----> <div class="column is-three-quarters"><div class="content"><h3 style="
    font-size: 36px;
    font-weight: 700;
