...
<br>
          <!-- New Skills Section End -->
           ...
           <!--<div class="signature mt-20"><img src="~/assets/uploads/signature-white.png" alt=""></div>-->
            ...
            <p><img src="~/assets/uploads/sf-plat.png" alt="" width="272" height="156" class=" wp-image-254 alignleft" style="width: 176px; padding: 10px;"> <img src="~/assets/uploads/deploymentlifecycle.png" alt="" width="272" height="156" class=" wp-image-254 alignleft" style="width: 176px; padding: 10px;"> <img src="~/assets/uploads/sf-admin.png" alt="" width="276" height="157" class="size-full wp-image-256 alignleft" style="width: 176px; padding: 10px;"><img src="~/assets/uploads/sf-builder.png" alt="" width="273" height="156" class="wp-image-255 alignleft" style="width: 176px; padding: 10px;"><img src="~/assets/uploads/sf-service.png" alt="" width="272" height="156" class=" wp-image-254 alignleft" style="width: 176px; padding: 10px;"></p></div></div> <aside class="column right-sidebar is-one-quarter"><div class="about-info">
