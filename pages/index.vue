<template>
  ...
  <main class="section page-main-section"><div class="container"><div class="columns"><!----> <div class="column is-three-quarters"><div class="content"><h3>Hello there, my name is Nick Huber.</h3> <p><strong></strong></p> <p>
...
Every time I successfully research and solve a complex issue or create something new for companies
 I cant help but feel a warm and fuzzy feeling inside. To show my appreciation I am logging and sharing
  examples, tricks, and solutions for other developers to also reach new heights aswell.
          </p> <div class="signature mt-20">
          <img src="https://huber.dev/img/signature-white.png" alt=""></div> <p>
          <img src="https://huber.dev/img/sf-plat.png" alt="" width="272" height="156" class=" wp-image-254 alignleft" style="width: 176px; padding: 10px;"> 
          <img src="https://huber.dev/img/deploymentlifecycle.jpg" alt="" width="272" height="156" class=" wp-image-254 alignleft" style="width: 176px; padding: 10px;">
           <img src="https://huber.dev/img/sf-admin.png" alt="" width="276" height="157" class="size-full wp-image-256 alignleft" style="width: 176px; padding: 10px;">
           <img src="https://huber.dev/img/sf-builder.jpg" alt="" width="273" height="156" class="wp-image-255 alignleft" style="width: 176px; padding: 10px;">
